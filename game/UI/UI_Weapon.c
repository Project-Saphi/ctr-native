...
{
	UI_WEAPON_ITEM_TURBO = 0,
	UI_WEAPON_ITEM_BOMB = 1,
	UI_WEAPON_ITEM_TNT = 3,
	UI_WEAPON_ITEM_POTION = 4,
	UI_WEAPON_ITEM_SPRING = 5,
	UI_WEAPON_ITEM_SHIELD = 6,
	UI_WEAPON_ITEM_MASK = 7,
	UI_WEAPON_ITEM_CLOCK = 8,
	UI_WEAPON_ITEM_WARPBALL = 9,
	UI_WEAPON_ITEM_NONE = 0xf,
	UI_WEAPON_ITEM_ROULETTE = 0x10,
	UI_WEAPON_ICON_BASE = 5,
	UI_WEAPON_JUICED_ICON_BASE = 0x11,
	UI_WEAPON_MASK_GOOD_CHARACTER_BITS = 0xc9,
	UI_WEAPON_MASK_UKA_ICON = 0x32,
	UI_WEAPON_JUICED_WUMPA_COUNT = 10,
...
CTR_STATIC_ASSERT(UI_WEAPON_JUICED_WUMPA_COUNT == 10);
...

{
	...
	if (itemID != UI_WEAPON_ITEM_ROULETTE)
	{
		...
		if ((d->numWumpas >= UI_WEAPON_JUICED_WUMPA_COUNT) &&
