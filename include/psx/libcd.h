...
void StSetStream(u_int mode, u_int start_frame, u_int end_frame, void (*func1)(), void (*func2)());
void StSetEmulate(u_int *addr, u_int mode, u_int start_frame, u_int end_frame, void (*func1)(), void (*func2)());
